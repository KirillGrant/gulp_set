...
gulp.task('sprite', function () {
  return gulp.src('source/build/img/icon-*.svg')
    .pipe(svgstore({
      inlineSvg: true
    }))
...
gulp.task('build', gulp.series('clean', 'copy:fonts', 'style', 'images', 'webp', 'sprite', 'html'));

gulp.task('sw', gulp.parallel('watch', 'serve'));

gulp.task('default', gulp.series(
  'clean', 'copy:fonts', 'style', 'images', 'webp', 'sprite', 'html',
